    ...
    var body: some View {
        GeometryReader { geometry in // Use do GeometryReader para acessar informações sobre o espaço de layout disponível.
            VStack { // Empilha as visualizações verticalmente.
                ...
                .background(.black)
                // Define o fundo do HStack como preto.
                .font(.system(size: 30)) // Define o tamanho da fonte para o HStack.
                .padding(.top, -40) // Ajusta o espaçamento acima do HStack para cima.
                .background(
                    Rectangle() // Adiciona um retângulo como fundo.
                        .foregroundColor(.black)
                        .frame(width: 300, height: 180) // Define o tamanho do quadro da imagem.
                        .padding(.bottom, -40)
// Ajusta a altura do retângulo conforme necessário.
                )
            }
        }
    }
